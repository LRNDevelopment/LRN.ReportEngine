/**********************************************************************************************
    LRN Report Engine - BeechTree_LRN deployment

    TARGET DATABASE : BeechTree_LRN
...
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData')
           AND c.name = 'ResponsibleParty' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData] ALTER COLUMN [ResponsibleParty] NVARCHAR(500) NULL;
GO
...
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData')
           AND c.name = 'EndDOS' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData] ALTER COLUMN [EndDOS] NVARCHAR(500) NULL;
GO
IF COL_LENGTH('dbo.LineLevelData', 'BillOccurance') IS NULL
    ALTER TABLE [dbo].[LineLevelData] ADD [BillOccurance] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData')
           AND c.name = 'BillOccurance' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData] ALTER COLUMN [BillOccurance] NVARCHAR(500) NULL;
GO
IF COL_LENGTH('dbo.LineLevelData', 'EntryUser') IS NULL
    ALTER TABLE [dbo].[LineLevelData] ADD [EntryUser] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData')
           AND c.name = 'EntryUser' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData] ALTER COLUMN [EntryUser] NVARCHAR(500) NULL;
GO
IF COL_LENGTH('dbo.LineLevelData', 'CPTUnits') IS NULL
    ALTER TABLE [dbo].[LineLevelData] ADD [CPTUnits] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData')
           AND c.name = 'CPTUnits' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData] ALTER COLUMN [CPTUnits] NVARCHAR(500) NULL;
GO
IF COL_LENGTH('dbo.LineLevelData', 'CPTMOD') IS NULL
    ALTER TABLE [dbo].[LineLevelData] ADD [CPTMOD] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData')
           AND c.name = 'CPTMOD' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData] ALTER COLUMN [CPTMOD] NVARCHAR(500) NULL;
GO
...
GO
IF COL_LENGTH('dbo.LineLevelData_Staging', 'ResponsibleParty') IS NULL
    ALTER TABLE [dbo].[LineLevelData_Staging] ADD [ResponsibleParty] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData_Staging')
           AND c.name = 'ResponsibleParty' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData_Staging] ALTER COLUMN [ResponsibleParty] NVARCHAR(500) NULL;
GO
...
GO
IF COL_LENGTH('dbo.LineLevelData_Staging', 'EndDOS') IS NULL
    ALTER TABLE [dbo].[LineLevelData_Staging] ADD [EndDOS] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData_Staging')
           AND c.name = 'EndDOS' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData_Staging] ALTER COLUMN [EndDOS] NVARCHAR(500) NULL;
GO
IF COL_LENGTH('dbo.LineLevelData_Staging', 'BillOccurance') IS NULL
    ALTER TABLE [dbo].[LineLevelData_Staging] ADD [BillOccurance] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData_Staging')
           AND c.name = 'BillOccurance' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData_Staging] ALTER COLUMN [BillOccurance] NVARCHAR(500) NULL;
GO
IF COL_LENGTH('dbo.LineLevelData_Staging', 'EntryUser') IS NULL
    ALTER TABLE [dbo].[LineLevelData_Staging] ADD [EntryUser] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData_Staging')
           AND c.name = 'EntryUser' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData_Staging] ALTER COLUMN [EntryUser] NVARCHAR(500) NULL;
GO
IF COL_LENGTH('dbo.LineLevelData_Staging', 'CPTUnits') IS NULL
    ALTER TABLE [dbo].[LineLevelData_Staging] ADD [CPTUnits] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData_Staging')
           AND c.name = 'CPTUnits' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData_Staging] ALTER COLUMN [CPTUnits] NVARCHAR(500) NULL;
GO
IF COL_LENGTH('dbo.LineLevelData_Staging', 'CPTMOD') IS NULL
    ALTER TABLE [dbo].[LineLevelData_Staging] ADD [CPTMOD] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData_Staging')
           AND c.name = 'CPTMOD' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData_Staging] ALTER COLUMN [CPTMOD] NVARCHAR(500) NULL;
GO
...
PRINT 'BeechTree_LRN deployment complete.';
GO
