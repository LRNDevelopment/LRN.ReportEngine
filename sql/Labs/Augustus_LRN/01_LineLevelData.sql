...
BEGIN
    ...
    (
        ...
        [EncounterPaymentPostedDate] NVARCHAR(255) NULL,
        [PanelNew] NVARCHAR(500) NULL,
        [Source] NVARCHAR(255) NULL,
        [UID] NVARCHAR(255) NULL,
        [Valid] NVARCHAR(255) NULL,
        ...
        [InsBalance] NVARCHAR(255) NULL,
        [PatBalance] NVARCHAR(255) NULL,
        [UpdatedDenial] NVARCHAR(255) NULL,
        [CombinedDenial] NVARCHAR(255) NULL,
