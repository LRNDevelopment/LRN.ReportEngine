...
public interface IAlertNotifier
{
	...
	Task SendTeamNotificationAsync(string title, string message, CancellationToken ct);
}
...
public sealed class AlertNotifier : IAlertNotifier
{
	...
	public async Task SendTeamNotificationAsync(string title, string message, CancellationToken ct)
	{
		// Send Teams (webhook to channel)
		try
		{
