/**********************************************************************************************
    LRN Report Engine - PCRCO_LRN deployment

    TARGET DATABASE : PCRCO_LRN
...
GO
IF COL_LENGTH('dbo.LineLevelData', 'DeniedWeek') IS NULL
    ALTER TABLE [dbo].[LineLevelData] ADD [DeniedWeek] NVARCHAR(500) NULL;   -- from lab mapping
GO
...
GO
IF COL_LENGTH('dbo.ClaimLevelData', 'DeniedWeek') IS NULL
    ALTER TABLE [dbo].[ClaimLevelData] ADD [DeniedWeek] NVARCHAR(500) NULL;   -- from lab mapping
GO
...
PRINT 'PCRCO_LRN deployment complete.';
GO