/**********************************************************************************************
    LRN Report Engine - PhiLife_LRN deployment

    TARGET DATABASE : PhiLife_LRN
...
IF COL_LENGTH('dbo.LineLevelData', 'ClientAccNum') IS NULL
    ALTER TABLE [dbo].[LineLevelData] ADD [ClientAccNum] NVARCHAR(500) NULL;   -- from lab mapping
GO
...
PRINT 'PhiLife_LRN deployment complete.';
GO