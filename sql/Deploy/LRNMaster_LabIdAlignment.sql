/**********************************************************************************************
    LRN Report Engine - LRNMaster LabId alignment (ONE-TIME)
    ...
    CONTENTS (in execution order):
      1. LabId alignment report (read-only)
      2. LabId alignment migration (DRY RUN until @Commit = 1)
...
/* ---------- LabId alignment report (read-only) ---------- */
GO
/*
...
/* ---------- LabId alignment migration (DRY RUN until @Commit = 1) ---------- */
GO
/*
