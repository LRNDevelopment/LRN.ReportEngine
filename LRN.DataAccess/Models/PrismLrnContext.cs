...
public partial class PrismLrnContext : DbContext
{
    public PrismLrnContext()
    {
    }

    public PrismLrnContext(DbContextOptions<PrismLrnContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BillingMasterId).HasName("PK__BillingM__4D6560C1D331131F");

            entity.ToTable("BillingMaster");

            entity.HasIndex(e => e.AccessionNo, "IX_BillingMaster_AccessionNo");

            entity.HasIndex(e => new { e.AccessionNo, e.Cptcode, e.CptcodeDescription, e.FirstBillDate }, "IX_BillingMaster_MergeMatch");

            entity.HasIndex(e => new { e.VisitNumber, e.ChargeEntryDate, e.FirstBillDate, e.LismasterId, e.PrimaryPayerId, e.PayerTypeId, e.BillingProviderId }, "IX_BillingMaster_VisitNumber");
            ...
            entity.Property(e => e.FirstBillDate).HasColumnType("datetime");
        ...
        {
            entity.HasKey(e => e.BillingProviderId).HasName("PK__BillingP__CB08769BB6BAB785");
            ...
            entity.HasIndex(e => e.BillingProvider, "UQ__BillingP__D9A75BBA6BAF9BE0").IsUnique();
        ...
        {
            entity.HasKey(e => e.ClaimId).HasName("PK__ClaimsPr__EF2E13BB5136EFB8");

            entity.ToTable("ClaimsProdStatus");
        ...
        {
            entity.HasKey(e => e.ClinicId).HasName("PK__ClinicMa__3347C2DDB71B997D");

            entity.ToTable("ClinicMaster");

            entity.HasIndex(e => e.ClinicName, "IX_ClinicMaster_Name");

            entity.HasIndex(e => e.ClinicName, "UQ__ClinicMa__A6FA56915A7CFE74").IsUnique();
        ...
        {
            entity.HasKey(e => e.CptcodeId).HasName("PK__CPTCodeM__E8517A8021B54390");
        ...
        {
            entity.HasKey(e => e.Ccwid).HasName("PK__CustomCo__A0D17AB1F0E2024F");

            entity.ToTable("CustomCollectionStaging");

            entity.HasIndex(e => new { e.ClaimId, e.BilledCptcode, e.LastBillDate, e.ChargeEntryDate, e.PayerName, e.PayerType, e.BillingProvider, e.MemberId, e.ClientAccNum, e.BeginDos, e.EndDos, e.BillingFrequency, e.ChargeEnteredBy, e.Pos, e.Tos, e.Modifier, e.Icd10code }, "IX_CustomCollectionData_Grouping");

            entity.HasIndex(e => e.BillingProvider, "IX_CustomCollectionStaging_BillingProvider");

            entity.HasIndex(e => e.ClaimId, "IX_CustomCollectionStaging_ClaimID");
        ...
        {
            entity.HasKey(e => e.DenailTrackId).HasName("PK__DenialTr__0E193358E30CE7C9");
        ...
        {
            entity.HasKey(e => e.ReportTypeId).HasName("PK__Download__78CF8CE3A2F7E42C");

            entity.HasIndex(e => e.ReportName, "UQ__Download__930D5CE7E33C0754").IsUnique();
        ...
        {
            entity.HasKey(e => e.IcdcodeId).HasName("PK__ICDCodeM__3145FF4EDE00D1AA");

            entity.ToTable("ICDCodeMaster");

            entity.HasIndex(e => e.Icd10code, "UQ__ICDCodeM__1712921F30A14A2F").IsUnique();
        ...
        {
            entity.HasKey(e => e.FileTypeId).HasName("PK__ImportFi__0896759E87B2F23C");

            entity.HasIndex(e => e.FileTypeName, "UQ__ImportFi__2A63AD8462164DA2").IsUnique();
        ...
        {
            entity.HasKey(e => e.ImportedFileId).HasName("PK__Imported__00000749DD617BCF");
        ...
        {
            entity.HasKey(e => e.InsurancePayerId).HasName("PK__Insuranc__10CDEBF79DB220D2");
            ...
            entity.HasIndex(e => e.PayerName, "UQ__Insuranc__F1989D97CCABFC21").IsUnique();
        ...
        {
            entity.HasKey(e => e.LabId).HasName("PK__LabMaste__EDBD773ACAAD954E");

            entity.ToTable("LabMaster");

            entity.HasIndex(e => e.LabName, "IX_LabMaster_Name");

            entity.HasIndex(e => e.LabName, "UQ__LabMaste__63D56130A639C317").IsUnique();
        ...
        {
            entity.HasKey(e => e.AccessionNo).HasName("PK__LISMaste__B4B23BD6EF7BC809");

            entity.ToTable("LISMaster");

            entity.HasIndex(e => e.AccessionNo, "IX_LISMaster_AccessionNo");

            entity.HasIndex(e => new { e.LismasterId, e.PanelId, e.ReferringProviderId }, "IX_LISMaster_LISMasterId");

            entity.HasIndex(e => e.SampleResultedDate, "IX_LISMaster_SampleResultedDate");
            ...
            entity.Property(e => e.ContractPay)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.FirstBilledDate).HasColumnType("datetime");
            entity.Property(e => e.Icd10code)
                .HasMaxLength(250)
                .HasColumnName("ICD10Code");
            entity.Property(e => e.LismasterId)
                .ValueGeneratedOnAdd()
                .HasColumnName("LISMasterId");
            ...
            entity.Property(e => e.PrimaryEffectiveDate).HasColumnType("datetime");
            ...
            entity.Property(e => e.ResultedStatus)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.SampleAccessionedDate).HasColumnType("datetime");
            entity.Property(e => e.SampleCollectedDate).HasColumnType("datetime");
            entity.Property(e => e.SampleReceivedDate).HasColumnType("datetime");
            entity.Property(e => e.SampleResultedDate).HasColumnType("datetime");
            entity.Property(e => e.SampleRunDate).HasColumnType("datetime");
            entity.Property(e => e.ScrubSettings)
                .HasMaxLength(500)
                .IsUnicode(false);
            entity.Property(e => e.SecondaryEffectiveDate).HasColumnType("datetime");
        ...
        {
            entity.HasKey(e => e.LisstagingId).HasName("PK__LISStagi__B4312D05D6CE9C16");
        ...
        {
            entity.HasKey(e => e.OperationGroupId).HasName("PK__Operatio__238426D1F402C4B5");

            entity.ToTable("OperationsGroupMaster");

            entity.HasIndex(e => e.OperationsGroup, "IX_OperationsGroupMaster_Name");

            entity.HasIndex(e => e.OperationsGroup, "UQ__Operatio__50488EDA7158F89B").IsUnique();
        ...
        {
            entity.HasKey(e => e.PanelGroupId).HasName("PK__PanelGro__E6B1A9B96EAAD3DF");
        ...
        {
            entity.HasKey(e => e.PayerTypeId).HasName("PK__PayerTyp__E34E46DC2D3FA1B4");
            ...
            entity.HasIndex(e => e.PayerType, "UQ__PayerTyp__04488EE0179D7171").IsUnique();
        ...
        {
            entity.HasKey(e => e.RuleId).HasName("PK__ProdStat__110458C2622ED55F");
        ...
        {
            entity.HasKey(e => e.ReferingProviderId).HasName("PK__Referrin__2A5C69B5F5466B2A");
            ...
            entity.HasIndex(e => e.ReferringProviderName, "UQ__Referrin__08359E04BC1D01A5").IsUnique();
        ...
        {
            entity.HasKey(e => e.SalesPersonId).HasName("PK__SalesPer__7A591C18D158E1DE");

            entity.ToTable("SalesPerson");

            entity.HasIndex(e => e.SalesPersonName, "UQ__SalesPer__AB543E20789E9773").IsUnique();
        ...
        {
            entity.HasKey(e => e.SpecimenStatusId).HasName("PK__Specimen__58A06263377435DE");

            entity.ToTable("SpecimenStatus");

            entity.HasIndex(e => e.SpecimenStatusName, "IX_SpecimenStatus_Name");

            entity.HasIndex(e => e.SpecimenStatusName, "UQ__Specimen__E60BFA8AE7FB96F4").IsUnique();
        ...
        {
            entity.HasKey(e => e.TestTypeId).HasName("PK__TestType__9BB876A6918EF0BA");

            entity.ToTable("TestTypeMaster");

            entity.HasIndex(e => e.TestTypeName, "IX_TestTypeMaster_Name");

            entity.HasIndex(e => e.TestTypeName, "UQ__TestType__662362AA4E4B732D").IsUnique();
        ...
        {
            entity.HasKey(e => e.TransactionDetailId).HasName("PK__Transact__F2B27FC69473D8B2");
        ...
        {
            entity.HasKey(e => e.Vaaid).HasName("PK__VisitAga__8A17DE035140CB54");
