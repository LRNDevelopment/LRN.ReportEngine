...
BEGIN
    ...
    (
        ...
        [DiagnosisPointer] NVARCHAR(255) NULL,
        ...
        [CPTXUnits] NVARCHAR(255) NULL,
        [CPTCombined] NVARCHAR(255) NULL,
        ...
        [LineLevelDenials] NVARCHAR(255) NULL,
        [DenialCombination] NVARCHAR(255) NULL,
        [PaymentPercent] NVARCHAR(255) NULL,
        [RejectionReasons] NVARCHAR(1000) NULL,
