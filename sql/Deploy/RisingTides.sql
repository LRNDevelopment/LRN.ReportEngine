/**********************************************************************************************
    LRN Report Engine - RisingTides deployment

    TARGET DATABASE : RisingTides
...
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData')
    ...
    ALTER TABLE [dbo].[LineLevelData] ALTER COLUMN [Facility] NVARCHAR(500) NULL;
GO
...
GO
IF COL_LENGTH('dbo.LineLevelData', 'ClientAccNum') IS NULL
    ALTER TABLE [dbo].[LineLevelData] ADD [ClientAccNum] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData')
           AND c.name = 'ClientAccNum' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData] ALTER COLUMN [ClientAccNum] NVARCHAR(500) NULL;
GO
...
GO
IF COL_LENGTH('dbo.LineLevelData', 'CPTs') IS NULL
    ALTER TABLE [dbo].[LineLevelData] ADD [CPTs] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData')
           AND c.name = 'CPTs' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData] ALTER COLUMN [CPTs] NVARCHAR(500) NULL;
GO
...
GO
IF COL_LENGTH('dbo.LineLevelData_Staging', 'Facility') IS NULL
    ALTER TABLE [dbo].[LineLevelData_Staging] ADD [Facility] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData_Staging')
           AND c.name = 'Facility' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData_Staging] ALTER COLUMN [Facility] NVARCHAR(500) NULL;
GO
...
GO
IF COL_LENGTH('dbo.LineLevelData_Staging', 'ClientAccNum') IS NULL
    ALTER TABLE [dbo].[LineLevelData_Staging] ADD [ClientAccNum] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData_Staging')
           AND c.name = 'ClientAccNum' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData_Staging] ALTER COLUMN [ClientAccNum] NVARCHAR(500) NULL;
GO
...
GO
IF COL_LENGTH('dbo.LineLevelData_Staging', 'CPTs') IS NULL
    ALTER TABLE [dbo].[LineLevelData_Staging] ADD [CPTs] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.LineLevelData_Staging')
           AND c.name = 'CPTs' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[LineLevelData_Staging] ALTER COLUMN [CPTs] NVARCHAR(500) NULL;
GO
...
GO
IF COL_LENGTH('dbo.ClaimLevelData', 'ModifierField') IS NULL
    ALTER TABLE [dbo].[ClaimLevelData] ADD [ModifierField] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.ClaimLevelData')
           AND c.name = 'ModifierField' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[ClaimLevelData] ALTER COLUMN [ModifierField] NVARCHAR(500) NULL;
GO
...
GO
IF COL_LENGTH('dbo.ClaimLevelData_Staging', 'ModifierField') IS NULL
    ALTER TABLE [dbo].[ClaimLevelData_Staging] ADD [ModifierField] NVARCHAR(500) NULL;
IF EXISTS (SELECT 1 FROM sys.columns c WHERE c.object_id = OBJECT_ID('dbo.ClaimLevelData_Staging')
           AND c.name = 'ModifierField' AND c.max_length <> -1 AND c.max_length < 1000)
    ALTER TABLE [dbo].[ClaimLevelData_Staging] ALTER COLUMN [ModifierField] NVARCHAR(500) NULL;
GO
...
PRINT 'RisingTides deployment complete.';
GO
